...
if __name__ == '__main__':
    ...
    for name, optimal_classifier in zip(names, optimal_classifiers):
        prediction = optimal_classifier.predict(test_data_second[EVALUATE_USING])
        precision = precision_score(test_data_second['Path'], prediction, average='weighted', zero_division=0)
        recall = recall_score(test_data_second['Path'], prediction, average='weighted', zero_division=0)
        f1score = f1_score(test_data_second['Path'], prediction, average='weighted', zero_division=0)
